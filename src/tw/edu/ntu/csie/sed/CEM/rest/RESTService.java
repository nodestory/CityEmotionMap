...
public class RESTService extends IntentService {
	...
	public static final String EXTRA_API_NAME = "tw.edu.ntu.csie.sed.CEM.API_NAME";
	public static final String EXTRA_HTTP_VERB = "tw.edu.ntu.csie.sed.CEM.EXTRA_HTTP_VERB";
	public static final String EXTRA_PARAMS = "tw.edu.ntu.csie.sed.CEM.EXTRA_PARAMS";
	public static final String EXTRA_RESULT_RECEIVER = "tw.edu.ntu.csie.sed.CEM.EXTRA_RESULT_RECEIVER";

	public static final String REST_API_NAME = "tw.edu.ntu.csie.sed.CEM.API_NAME";
	...
	protected void onHandleIntent(Intent intent) {
		...
		try {
			...
			case POST: {
				...
				if (params != null) {
					UrlEncodedFormEntity formEntity = new UrlEncodedFormEntity(paramsToList(params), HTTP.UTF_8);
			...
			if (request != null) {
				...
				// to the caller. This
				// class has a method named send() that can send back a code and
				// a Bundle
				// of data. ResultReceiver and IntentService abstract away all
				// the IPC code
				// we would need to write to normally make this work.
				if (responseEntity != null) {
					Bundle resultData = new Bundle();
					resultData.putInt(REST_API_NAME, extras.getInt(EXTRA_API_NAME));
